            ...
            AnimatedBuilder(
              ...
              builder: (context, child) {
                var horizontalAnimation = Tween<double>(
                  begin: (widget.direction == PopDirection.fowardX
                      ? widget.posX + randoms[i][0]
                      : constraints.maxWidth - widget.posX - randoms[i][0]),
                  end: (widget.direction == PopDirection.fowardX
                ...
                var rotationXAnimation =
                    Tween<double>(begin: 0, end: pi * randoms[i][4])
                        .animate(widget.controller);
                var rotationYAnimation =
                    Tween<double>(begin: 0, end: pi * randoms[i][5])
                        .animate(widget.controller);
                var rotationZAnimation =
                    Tween<double>(begin: 0, end: pi * randoms[i][6])
                        .animate(widget.controller);
                return Positioned(
              ...
              child: Container(
                ...
                color: colors[Random().nextInt(colors.length)]!
                    .withAlpha(Random().nextInt(55) + 200),
              ),
            ),
        ],
      );
